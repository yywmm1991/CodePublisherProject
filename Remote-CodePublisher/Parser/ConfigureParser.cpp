...
ConfigParseForCodeAnal::~ConfigParseForCodeAnal()
{
  ...
  // Handle the rule and action for enum
  delete pEnumDefinition;
  delete pHandleEnumDefinition;
  // Handle the rule and action for typedef
  delete pTypeDef;
  delete pHandleTypeDef;
  // Handle the rule and action for aliases
  delete pAlias;
  delete pHandleAlias;
}
...
void ConfigParseForCodeAnal::handleScope() {
...
void ConfigParseForCodeAnal::handleDefinition() {
	...
	// Add rule and action for typedef
	pTypeDef = new DetectTypeDef;
	pHandleTypeDef = new HandleTypeDef(pRepo);
	pTypeDef->addAction(pHandleTypeDef);
	pParser->addRule(pTypeDef);

	// Add rule and action for typedef
	pAlias = new DetectAliases;
	pHandleAlias = new HandleAliases(pRepo);
	pAlias->addAction(pHandleAlias);
